...
new_task:
  ...
  message: |
    ...
    1. Frissítsd a TASK_TREE.md-t (✅ erre a fájlra, 🚧 a következőre).
    2. Jelentsd vissza a következő fájl nevét!
...
TOKEN/LOOP VÉDELEM
Az Orchestrator 5-10 fájl után álljon meg és kérjen megerősítést, hogy elkerüljük a végtelen loop-ot és context túlcsordulást.
🚀 INDÍTÁSI PARANCS
