...
class TestBaseWidget:
    ...
    def test_initialization_without_config(self) -> None:
        ...
        assert widget._config == {}  # type: ignore
        assert widget._visible is True  # type: ignore
    ...
    def test_initialization_with_config(self) -> None:
        ...
        assert widget._config == config  # type: ignore
        assert widget._visible is True  # type: ignore
    ...
    def test_show_sets_visible_to_true(self) -> None:
        ...
        widget = BaseWidget()
        widget._visible = False  # type: ignore
    ...
    def test_hide_sets_visible_to_false(self) -> None:
        ...
        assert widget._visible is False  # type: ignore
