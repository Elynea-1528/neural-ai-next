...
class TestDIContainerInterface:
    ...
    def test_interface_has_correct_type_hints(self) -> None:
        ...
        for method_name in methods_to_check:
            ...
            assert len(sig.parameters) > 0 or sig.return_annotation is not (
    ...
    def test_interface_uses_generic_types(self) -> None:
        ...
        assert "TypeVar" in source or "T" in source, "Az interfész nem használ generikus típusokat"
...
class TestLazyComponentInterface:
    ...
    def test_interface_has_required_methods(self) -> None:
        ...
        for method_name in required_methods:
            assert hasattr(LazyComponentInterface, method_name), f"Hiányzó metódus: {method_name}"
    ...
    def test_interface_methods_are_abstract(self) -> None:
        ...
        assert is_loaded_property.fget is not None, "is_loaded property-nek nincs getter-e"
    ...
    def test_interface_has_correct_type_hints(self) -> None:
        ...
        assert isinstance(is_loaded_prop, property), "is_loaded nem property"
        assert is_loaded_prop.fget is not None, "is_loaded property-nek nincs getter-e"
