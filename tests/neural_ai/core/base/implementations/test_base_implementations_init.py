...
import neural_ai.core.base.implementations as implementations_module
...
def test_implementations_init_exports_nothing() -> None:
    ...
    # Assert
    assert exports == [], "Az implementations __init__.py nem exportálhat semmit (DDD szabály)"
...
def test_implementations_init_has_docstring() -> None:
    ...
    assert "Implementációk" in docstring, "A docstring tartalmazza az 'Implementációk' szót"
    assert "ÜRES" in docstring or "üres" in docstring, "A docstring jelzi, hogy üres kell legyen"
