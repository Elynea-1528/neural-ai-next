...
class TestMarketDataPersisterOnMarketData:
    ...
    async def test_on_market_data_triggers_flush_at_limit(self) -> None:
        ...
        persister._flush_all_buffers = AsyncMock()  # type: ignore[method-assign]
        ...
        persister._flush_all_buffers.assert_called_once()  # pyright: ignore[reportPrivateUsage]
...
class TestMarketDataPersisterPeriodicFlush:
    ...
    async def test_periodic_flush_triggers_on_new_hour(self) -> None:
        ...
        task = asyncio.create_task(persister._periodic_flush_task())  # pyright: ignore[reportPrivateUsage]
        ...
        persister._flush_all_buffers.assert_called()  # pyright: ignore[reportPrivateUsage]
    ...
    async def test_periodic_flush_handles_exception(self) -> None:
        ...
        persister._flush_all_buffers = AsyncMock(side_effect=Exception("Test error"))  # type: ignore[method-assign]
...
class TestMarketDataPersisterFlush:
    ...
    async def test_flush_all_buffers_with_data(self) -> None:
        ...
        persister._flush_symbol_buffer = AsyncMock()  # type: ignore[method-assign]

        await persister._flush_all_buffers()  # pyright: ignore[reportPrivateUsage]

        persister._flush_symbol_buffer.assert_called_once()  # pyright: ignore[reportPrivateUsage]
        assert len(persister.buffer) == 0
    ...
    async def test_flush_symbol_buffer_success(self) -> None:
        ...
        persister._save_events_to_storage = AsyncMock()  # type: ignore[method-assign]

        await persister._flush_symbol_buffer("EURUSD", events)  # pyright: ignore[reportPrivateUsage]

        persister._save_events_to_storage.assert_called_once()  # pyright: ignore[reportPrivateUsage]
    ...
    async def test_flush_symbol_buffer_empty(self) -> None:
        ...
        await persister._flush_symbol_buffer("EURUSD", [])  # pyright: ignore[reportPrivateUsage]
    ...
    async def test_flush_symbol_buffer_handles_exception(self) -> None:
        ...
        persister._save_events_to_storage = AsyncMock(side_effect=Exception("Test error"))  # type: ignore[method-assign]
...
class TestMarketDataPersisterSave:
    ...
    async def test_save_events_to_storage_with_parquet_service(self) -> None:
        ...
        with patch("builtins.isinstance", return_value=True):
            ...
            await persister._save_events_to_storage("EURUSD", events, date)  # pyright: ignore[reportPrivateUsage]
    ...
    async def test_save_events_to_storage_empty(self) -> None:
        ...
        await persister._save_events_to_storage("EURUSD", [], date)  # pyright: ignore[reportPrivateUsage]
...
class TestMarketDataPersisterConvertToDataFrame:
    ...
    def test_convert_events_to_dataframe_with_pandas(self) -> None:
        ...
        df = persister._convert_events_to_dataframe(events)  # pyright: ignore[reportPrivateUsage]
    ...
    def test_convert_events_to_dataframe_no_library(self) -> None:
        ...
        with patch.dict("sys.modules", {"pandas": None, "polars": None}):
            with pytest.raises(RuntimeError, match="Sem pandas, sem polars nincs telepítve"):
                persister._convert_events_to_dataframe(events)  # pyright: ignore[reportPrivateUsage]
