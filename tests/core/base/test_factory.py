...
class TestCoreComponentFactory:
    ...
    def test_validate_dependencies_storage_invalid_path(self) -> None:
        ...
        config = {"base_directory": "/nonexistent/path/to/storage"}
    ...
    def test_validate_dependencies_storage_valid(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"base_directory": str(storage_path)}
    ...
    def test_create_logger(
        ...
        mock_get_logger.assert_called_once_with(name="test_logger", config={"name": "test_logger", "level": "INFO"})
