...
class TestExceptions(unittest.TestCase):
    ...
    def test_neural_ai_exception(self) -> None:
        """NeuralAIException alap kivétel tesztelését végzi."""
    ...
    def test_storage_exception_hierarchy(self) -> None:
        """Tárolási kivétel hierarchia tesztelését végzi."""
    ...
    def test_storage_write_error(self) -> None:
        """StorageWriteError kivétel tesztelését végzi."""
    ...
    def test_storage_read_error(self) -> None:
        """StorageReadError kivétel tesztelését végzi."""
    ...
    def test_storage_permission_error(self) -> None:
        """StoragePermissionError kivétel tesztelését végzi."""
    ...
    def test_insufficient_disk_space_error(self) -> None:
        """InsufficientDiskSpaceError kivétel tesztelését végzi."""
    ...
    def test_permission_denied_error(self) -> None:
        """PermissionDeniedError kivétel tesztelését végzi."""
    ...
    def test_singleton_violation_error(self) -> None:
        """SingletonViolationError kivétel tesztelését végzi."""
    ...
    def test_component_not_found_error(self) -> None:
        """ComponentNotFoundError kivétel tesztelését végzi."""
    ...
    def test_network_exception_hierarchy(self) -> None:
        """Hálózati kivétel hierarchia tesztelését végzi."""
    ...
    def test_exception_inheritance_chain(self) -> None:
        """Kivétel öröklési lánc ellenőrzését végzi."""
