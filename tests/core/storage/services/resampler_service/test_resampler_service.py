...
class TestResamplerService:
    ...
    def test_convert_to_ohlcv_empty_data(
        self,
        resampler: ResamplerService
    ):
...
class TestResamplerServiceFactory:
    ...
    @patch('neural_ai.core.storage.services.resampler_service.factory.DIContainer')
...
class TestResamplerErrorHierarchy:
    ...
    def test_data_load_error_creation(self):
        ...
        original_error = IOError("Fájl nem található")
