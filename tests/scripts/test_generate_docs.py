...
class TestGenerateDocsIntegration:
    ...
    def test_generate_docs_imports(self, project_root: Path) -> None:
        ...
        # Act & Assert
        from scripts import generate_docs  # noqa: F401  # pyright: ignore[reportUnusedImport]
    ...
    def test_generate_docs_execution_dry_run(self, project_root: Path) -> None:
        ...
        """
        # Arrange
        project_root / "scripts" / "generate_docs.py"  # pyright: ignore[reportUnusedExpression]
