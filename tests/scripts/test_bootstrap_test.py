...
class TestBootstrapTestIntegration:
    ...
    def test_bootstrap_test_imports(self, project_root: Path) -> None:
        ...
        # Act & Assert
        from scripts import bootstrap_test  # noqa: F401  # pyright: ignore[reportUnusedImport]
    ...
    def test_bootstrap_test_execution_dry_run(self, project_root: Path) -> None:
        ...
        """
        # Arrange
        project_root / "scripts" / "bootstrap_test.py"  # pyright: ignore[reportUnusedExpression]
