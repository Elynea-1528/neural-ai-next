...
**Generálva:** 2026-02-20 22:34:12 UTC
...
| `tests/neural_ai/core/base/implementations/test_di_container.py` | 🔴 VULNERABLE | **24**/1/0/0 | N/A | 0 / 0 / 17 | - | ❌ | 🔴 **Tesztek javítása: 1 failed, 0 error** | 🔎 Pylance: 17 hiba javítása |
| `tests/neural_ai/core/base/implementations/test_implementations_init.py` | ✅ SECURE | **13**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
...
| `tests/neural_ai/core/base/interfaces/test_interfaces_init.py` | 🟡 WARNING | **12**/0/0/0 | N/A | 0 / 0 / 4 | - | ❌ | 🔎 Pylance: 4 hiba javítása |
| `tests/neural_ai/core/base/test_base_init.py` | ✅ SECURE | **8**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/base/test_factory.py` | 🔴 VULNERABLE | **29**/7/0/0 | N/A | 0 / 0 / 39 | - | ❌ | 🔴 **Tesztek javítása: 7 failed, 0 error** | 🔎 Pylance: 39 hiba javítása |
| `tests/neural_ai/core/config/exceptions/test___init__.py` | ✅ SECURE | **22**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/config/exceptions/test_config_error.py` | ✅ SECURE | **15**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/config/implementations/test_config_implementations_init.py` | ✅ SECURE | **4**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/config/implementations/test_dynamic_config_manager.py` | 🟡 WARNING | **48**/0/0/0 | N/A | 0 / 0 / 54 | - | ❌ | 🔎 Pylance: 54 hiba javítása |
| `tests/neural_ai/core/config/implementations/test_dynamic_config_manager_comprehensive.py` | 🟡 WARNING | **13**/0/0/0 | N/A | 0 / 0 / 9 | - | ❌ | 🔎 Pylance: 9 hiba javítása |
| `tests/neural_ai/core/config/implementations/test_yaml_config_manager.py` | 🟡 WARNING | **65**/0/0/0 | N/A | 0 / 0 / 17 | - | ❌ | 🔎 Pylance: 17 hiba javítása |
| `tests/neural_ai/core/config/interfaces/test___init__.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ❌ | - |
...
| `tests/neural_ai/core/config/test___init__.py` | 🟡 WARNING | - | N/A | 0 / 0 / 3 | - | ❌ | 🔎 Pylance: 3 hiba javítása |
...
| `tests/neural_ai/core/config/test_yaml_config_manager_validation.py` | ✅ SECURE | **11**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
...
| `tests/neural_ai/core/db/implementations/test_db_implementations_init.py` | 🟡 WARNING | **8**/0/0/0 | N/A | 0 / 0 / 3 | - | ❌ | 🔎 Pylance: 3 hiba javítása |
...
| `tests/neural_ai/core/db/implementations/test_sqlalchemy_session.py` | 🔴 VULNERABLE | **13**/9/0/3 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 9 failed, 0 error** | ⏭️ 3 skipped teszt aktiválása |
...
| `tests/neural_ai/core/db/test_db_init.py` | ✅ SECURE | **8**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
...
| `tests/neural_ai/core/events/implementations/test_events_implementations_init.py` | ✅ SECURE | **4**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/events/implementations/test_zeromq_bus.py` | 🔴 VULNERABLE | **24**/25/0/0 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 25 failed, 0 error** |
...
| `tests/neural_ai/core/events/test_events_factory.py` | 🔴 VULNERABLE | **7**/5/0/0 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 5 failed, 0 error** |
...
| `tests/neural_ai/core/logger/interfaces/test_logger_interfaces_init.py` | ✅ SECURE | **4**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/logger/test_logger_factory.py` | ✅ SECURE | **12**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/core/logger/test_logger_init.py` | 🔴 VULNERABLE | **13**/1/0/0 | N/A | 0 / 0 / 2 | - | ❌ | 🔴 **Tesztek javítása: 1 failed, 0 error** | 🔎 Pylance: 2 hiba javítása |
...
| `tests/neural_ai/core/test_core_init.py` | 🔴 VULNERABLE | **12**/7/0/0 | N/A | 0 / 0 / 28 | - | ❌ | 🔴 **Tesztek javítása: 7 failed, 0 error** | 🔎 Pylance: 28 hiba javítása |
| `tests/neural_ai/core/test_init_version_fallback.py` | 🔴 VULNERABLE | **4**/1/0/0 | N/A | 0 / 0 / 2 | - | ❌ | 🔴 **Tesztek javítása: 1 failed, 0 error** | 🔎 Pylance: 2 hiba javítása |
| `tests/neural_ai/core/test_pyproject_ui_dependencies.py` | 🔴 VULNERABLE | **0**/6/0/0 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 6 failed, 0 error** |
...
| `tests/neural_ai/core/utils/test_decorators.py` | 🔴 VULNERABLE | **2**/11/0/0 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 11 failed, 0 error** |
...
| `tests/neural_ai/data/storage/backends/test_base.py` | 🔴 VULNERABLE | **2**/6/0/0 | N/A | 0 / 0 / 76 | - | ❌ | 🔴 **Tesztek javítása: 6 failed, 0 error** | 🔎 Pylance: 76 hiba javítása |
...
| `tests/neural_ai/data/storage/implementations/test_file_storage.py` | 🟡 WARNING | **50**/0/0/2 | N/A | 0 / 0 / 30 | - | ❌ | 🔎 Pylance: 30 hiba javítása | ⏭️ 2 skipped teszt aktiválása |
| `tests/neural_ai/data/storage/implementations/test_parquet_storage.py` | 🟡 WARNING | **34**/0/0/0 | N/A | 0 / 0 / 2 | - | ❌ | 🔎 Pylance: 2 hiba javítása |
...
| `tests/neural_ai/processors/dimensions/d02_support/test_processor.py` | 🟡 WARNING | - | N/A | 0 / 0 / 28 | - | ❌ | 🔎 Pylance: 28 hiba javítása |
| `tests/neural_ai/processors/test_factory.py` | 🟡 WARNING | **3**/0/0/0 | N/A | 0 / 0 / 14 | - | ❌ | 🔎 Pylance: 14 hiba javítása |
| `tests/neural_ai/processors/test_time_alignment_service.py` | 🟡 WARNING | **8**/0/0/0 | N/A | 0 / 0 / 2 | - | ❌ | 🔎 Pylance: 2 hiba javítása |
...
| `tests/neural_ai/ui/services/test_data_service.py` | ✅ SECURE | **26**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/ui/services/test_strategy_service.py` | 🟡 WARNING | **24**/0/0/0 | N/A | 0 / 0 / 18 | - | ❌ | 🔎 Pylance: 18 hiba javítása |
| `tests/neural_ai/ui/test_app.py` | ✅ SECURE | **15**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/ui/test_core_bridge.py` | ✅ SECURE | **21**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/neural_ai/ui/test_ui_factory.py` | ✅ SECURE | **28**/0/0/0 | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/scripts/__init__.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ❌ | - |
| `tests/scripts/test_data_reset.py` | 🔴 VULNERABLE | **12**/2/0/0 | N/A | 0 / 0 / 0 | - | ❌ | 🔴 **Tesztek javítása: 2 failed, 0 error** |
| `tests/scripts/test_download_history.py` | 🔴 VULNERABLE | **9**/2/0/0 | N/A | 0 / 0 / 1 | - | ❌ | 🔴 **Tesztek javítása: 2 failed, 0 error** | 🔎 Pylance: 1 hiba javítása |
| `tests/scripts/test_migrate_structure.py` | 🔴 VULNERABLE | **12**/1/0/0 | N/A | 0 / 0 / 10 | - | ❌ | 🔴 **Tesztek javítása: 1 failed, 0 error** | 🔎 Pylance: 10 hiba javítása |
| `tests/scripts/test_test_tick_pipeline.py` | 🔴 VULNERABLE | **1**/4/0/0 | N/A | 0 / 0 / 8 | - | ❌ | 🔴 **Tesztek javítása: 4 failed, 0 error** | 🔎 Pylance: 8 hiba javítása |
...
| `scripts/audit_data.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/bootstrap_integration_test.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/bootstrap_test.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/data_reset.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/deploy_jforex.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/download_history.py` | 🟡 WARNING | ✅ FOUND | - | N/A | 0 / 0 / 2 | - | ⚪ N/A | ⚪ N/A | ✅ | 🔎 Pylance: 2 hiba javítása |
| `scripts/force_kill.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/generate.py` | 🟡 WARNING | ❌ MISSING | - | N/A | 0 / 0 / 88 | - | ⚪ N/A | ⚪ N/A | ✅ | 🔎 Pylance: 88 hiba javítása |
| `scripts/generate_docs.py` | 🟡 WARNING | ❌ MISSING | - | N/A | 0 / 0 / 11 | - | ⚪ N/A | ⚪ N/A | ✅ | 🔎 Pylance: 11 hiba javítása |
| `scripts/install.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/migrate_structure.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/smart_pack.py` | ✅ SECURE | ❌ MISSING | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `scripts/test_d2_standalone.py` | 🟡 WARNING | ❌ MISSING | - | N/A | 0 / 0 / 25 | - | ⚪ N/A | ⚪ N/A | ✅ | 🔎 Pylance: 25 hiba javítása |
