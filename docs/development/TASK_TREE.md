...
| File Path | Matrix `[S|T|D]` | Stmt Coverage | Brch Coverage | Complexity | Status | Token Cost | Commit Hash |
|:----------|:----------------:|:--------------|:--------------|:----------:|:------:|:----------:|:-----------:|
| `test_core_components.py` | `[✅|✅|✅]` | `🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜` **86%** | `🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜` **86%** | ⭐⭐⭐⭐ | `✅ PERFECT` | N/A | N/A |
| `test_exceptions.py` | `[✅|✅|✅]` | `🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩` **100%** | `🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩` **100%** | ⭐⭐⭐⭐ | `✅ PERFECT` | ~10k | 49100fb |
