...
| `core/base/implementations/di_container.py` | 🟡 WARNING | ✅ FOUND | - | N/A | 0 / 0 / 11 | - | ⚪ N/A | ⚪ N/A | ✅ | 🔎 Pylance: 11 hiba javítása |
...
| `core/config/implementations/dynamic_config_manager.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `core/config/implementations/yaml_config_manager.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ✅ OK | ⚪ N/A | ✅ | - |
...
| `core/db/implementations/sqlalchemy_session.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
...
| `core/events/implementations/zeromq_bus.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ✅ OK | ⚪ N/A | ✅ | - |
...
| `core/logger/implementations/colored_logger.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `core/logger/implementations/default_logger.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
| `core/logger/implementations/rotating_file_logger.py` | ✅ SECURE | ✅ FOUND | - | N/A | 0 / 0 / 0 | - | ⚪ N/A | ⚪ N/A | ✅ | - |
...
| `tests/conftest.py` | 🟡 WARNING | - | N/A | 0 / 0 / 12 | - | ✅ | 🔎 Pylance: 12 hiba javítása |
...
| `tests/neural_ai/collectors/jforex/exceptions/test_jforex_error.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
...
| `tests/neural_ai/collectors/jforex/interfaces/test_jforex_downloader_interface.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/collectors/jforex/interfaces/test_jforex_interfaces_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/collectors/jforex/interfaces/test_jforex_live_interface.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/collectors/jforex/interfaces/test_jforex_tick_data.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/collectors/jforex/mocks/__init__.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/collectors/jforex/test_bi5_downloader.py` | 🟡 WARNING | - | N/A | 0 / 1 / 286 | - | ✅ | 🔬 Mypy: 1 type hiba javítása | 🔎 Pylance: 286 hiba javítása |
...
| `tests/neural_ai/collectors/jforex/test_live_feed_integration.py` | 🟡 WARNING | - | N/A | 0 / 2 / 17 | - | ✅ | 🔬 Mypy: 2 type hiba javítása | 🔎 Pylance: 17 hiba javítása |
...
| `tests/neural_ai/core/base/implementations/test_base_implementations_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
...
| `tests/neural_ai/core/base/implementations/test_singleton.py` | 🟡 WARNING | - | N/A | 0 / 1 / 0 | - | ✅ | 🔬 Mypy: 1 type hiba javítása |
| `tests/neural_ai/core/base/interfaces/test_base_interfaces_init.py` | 🟡 WARNING | - | N/A | 0 / 4 / 0 | - | ✅ | 🔬 Mypy: 4 type hiba javítása |
| `tests/neural_ai/core/base/interfaces/test_component_interface.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/base/interfaces/test_container_interface.py` | 🟡 WARNING | - | N/A | 0 / 12 / 0 | - | ✅ | 🔬 Mypy: 12 type hiba javítása |
| `tests/neural_ai/core/base/test_base_factory.py` | 🟡 WARNING | - | N/A | 0 / 6 / 55 | - | ✅ | 🔬 Mypy: 6 type hiba javítása | 🔎 Pylance: 55 hiba javítása |
...
| `tests/neural_ai/core/config/implementations/test_dynamic_config_manager.py` | 🟡 WARNING | - | N/A | 0 / 4 / 63 | - | ✅ | 🔬 Mypy: 4 type hiba javítása | 🔎 Pylance: 63 hiba javítása |
| `tests/neural_ai/core/config/implementations/test_yaml_config_manager.py` | 🟡 WARNING | - | N/A | 0 / 7 / 31 | - | ✅ | 🔬 Mypy: 7 type hiba javítása | 🔎 Pylance: 31 hiba javítása |
| `tests/neural_ai/core/config/interfaces/test_async_config_interface.py` | 🟡 WARNING | - | N/A | 0 / 2 / 0 | - | ✅ | 🔬 Mypy: 2 type hiba javítása |
| `tests/neural_ai/core/config/interfaces/test_config_interface.py` | 🟡 WARNING | - | N/A | 0 / 2 / 0 | - | ✅ | 🔬 Mypy: 2 type hiba javítása |
| `tests/neural_ai/core/config/interfaces/test_config_interfaces_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/config/interfaces/test_factory_interface.py` | 🟡 WARNING | - | N/A | 0 / 3 / 11 | - | ✅ | 🔬 Mypy: 3 type hiba javítása | 🔎 Pylance: 11 hiba javítása |
| `tests/neural_ai/core/config/interfaces/test_types.py` | 🟡 WARNING | - | N/A | 0 / 36 / 0 | - | ✅ | 🔬 Mypy: 36 type hiba javítása |
| `tests/neural_ai/core/config/test_config_factory.py` | 🟡 WARNING | - | N/A | 0 / 1 / 0 | - | ✅ | 🔬 Mypy: 1 type hiba javítása |
| `tests/neural_ai/core/config/test_config_init.py` | 🟡 WARNING | - | N/A | 0 / 0 / 5 | - | ✅ | 🔎 Pylance: 5 hiba javítása |
...
| `tests/neural_ai/core/db/implementations/test_db_implementations_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/db/implementations/test_model_base.py` | 🟡 WARNING | - | N/A | 0 / 2 / 0 | - | ✅ | 🔬 Mypy: 2 type hiba javítása |
| `tests/neural_ai/core/db/implementations/test_models.py` | 🟡 WARNING | - | N/A | 0 / 13 / 13 | - | ✅ | 🔬 Mypy: 13 type hiba javítása | 🔎 Pylance: 13 hiba javítása |
...
| `tests/neural_ai/core/db/test_db_factory.py` | 🟡 WARNING | - | N/A | 0 / 7 / 7 | - | ✅ | 🔬 Mypy: 7 type hiba javítása | 🔎 Pylance: 7 hiba javítása |
...
| `tests/neural_ai/core/events/implementations/test_zeromq_bus.py` | 🟡 WARNING | - | N/A | 0 / 1 / 50 | - | ✅ | 🔬 Mypy: 1 type hiba javítása | 🔎 Pylance: 50 hiba javítása |
| `tests/neural_ai/core/events/interfaces/test_event_bus_interface.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/neural_ai/core/events/interfaces/test_event_models.py` | 🟡 WARNING | - | N/A | 0 / 14 / 8 | - | ✅ | 🔬 Mypy: 14 type hiba javítása | 🔎 Pylance: 8 hiba javítása |
...
| `tests/neural_ai/core/logger/interfaces/test_logger_interface.py` | 🟡 WARNING | - | N/A | 0 / 16 / 0 | - | ✅ | 🔬 Mypy: 16 type hiba javítása |
| `tests/neural_ai/core/logger/interfaces/test_logger_interfaces_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/logger/test_logger_factory.py` | 🟡 WARNING | - | N/A | 0 / 0 / 4 | - | ✅ | 🔎 Pylance: 4 hiba javítása |
| `tests/neural_ai/core/logger/test_logger_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/system/exceptions/test_health_error.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
...
| `tests/neural_ai/core/system/interfaces/test_health_interface.py` | 🟡 WARNING | - | N/A | 0 / 7 / 16 | - | ✅ | 🔬 Mypy: 7 type hiba javítása | 🔎 Pylance: 16 hiba javítása |
...
| `tests/neural_ai/core/test_core_init.py` | 🟡 WARNING | - | N/A | 0 / 5 / 36 | - | ✅ | 🔬 Mypy: 5 type hiba javítása | 🔎 Pylance: 36 hiba javítása |
| `tests/neural_ai/core/utils/exceptions/test_util_error.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/core/utils/exceptions/test_utils_exceptions_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
...
| `tests/neural_ai/data/ingestion/test_market_data_persister.py` | 🟡 WARNING | - | N/A | 0 / 6 / 24 | - | ✅ | 🔬 Mypy: 6 type hiba javítása | 🔎 Pylance: 24 hiba javítása |
| `tests/neural_ai/data/storage/backends/test_base.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/data/storage/backends/test_pandas_backend.py` | 🟡 WARNING | - | N/A | 0 / 11 / 22 | - | ✅ | 🔬 Mypy: 11 type hiba javítása | 🔎 Pylance: 22 hiba javítása |
| `tests/neural_ai/data/storage/backends/test_polars_backend.py` | 🟡 WARNING | - | N/A | 0 / 5 / 13 | - | ✅ | 🔬 Mypy: 5 type hiba javítása | 🔎 Pylance: 13 hiba javítása |
...
| `tests/neural_ai/data/storage/implementations/test_file_storage.py` | 🟡 WARNING | - | N/A | 0 / 5 / 34 | - | ✅ | 🔬 Mypy: 5 type hiba javítása | 🔎 Pylance: 34 hiba javítása |
| `tests/neural_ai/data/storage/implementations/test_parquet_storage.py` | 🟡 WARNING | - | N/A | 0 / 17 / 23 | - | ✅ | 🔬 Mypy: 17 type hiba javítása | 🔎 Pylance: 23 hiba javítása |
...
| `tests/neural_ai/data/storage/test_storage_factory.py` | 🟡 WARNING | - | N/A | 0 / 7 / 8 | - | ✅ | 🔬 Mypy: 7 type hiba javítása | 🔎 Pylance: 8 hiba javítása |
...
| `tests/neural_ai/processors/dimensions/d02_support/implementations/test_support_processor.py` | 🟡 WARNING | - | N/A | 0 / 5 / 218 | - | ✅ | 🔬 Mypy: 5 type hiba javítása | 🔎 Pylance: 218 hiba javítása |
...
| `tests/neural_ai/processors/implementations/test_time_alignment_service.py` | 🟡 WARNING | - | N/A | 0 / 16 / 0 | - | ✅ | 🔬 Mypy: 16 type hiba javítása |
| `tests/neural_ai/processors/interfaces/test_processors_dimension_processor_interface.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/processors/interfaces/test_processors_interfaces_init.py` | 🟡 WARNING | - | N/A | 0 / 0 / 1 | - | ✅ | 🔎 Pylance: 1 hiba javítása |
...
| `tests/neural_ai/processors/resampler_service/test_resampler_service_init.py` | 🟡 WARNING | - | N/A | 0 / 0 / 1 | - | ✅ | 🔎 Pylance: 1 hiba javítása |
...
| `tests/neural_ai/ui/components/test_base_widget.py` | 🟡 WARNING | - | N/A | 0 / 0 / 9 | - | ✅ | 🔎 Pylance: 9 hiba javítása |
...
| `tests/neural_ai/ui/pages/test_data_hub_page.py` | 🟡 WARNING | - | N/A | 0 / 22 / 0 | - | ✅ | 🔬 Mypy: 22 type hiba javítása |
| `tests/neural_ai/ui/pages/test_dev_center_page.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/ui/pages/test_launchpad_page.py` | 🟡 WARNING | - | N/A | 0 / 21 / 0 | - | ✅ | 🔬 Mypy: 21 type hiba javítása |
...
| `tests/neural_ai/ui/pages/test_strategy_lab_page.py` | 🟡 WARNING | - | N/A | 0 / 43 / 0 | - | ✅ | 🔬 Mypy: 43 type hiba javítása |
| `tests/neural_ai/ui/services/test_ai_service.py` | 🟡 WARNING | - | N/A | 0 / 1 / 10 | - | ✅ | 🔬 Mypy: 1 type hiba javítása | 🔎 Pylance: 10 hiba javítása |
| `tests/neural_ai/ui/services/test_dashboard_service.py` | 🟡 WARNING | - | N/A | 0 / 1 / 8 | - | ✅ | 🔬 Mypy: 1 type hiba javítása | 🔎 Pylance: 8 hiba javítása |
| `tests/neural_ai/ui/services/test_data_service.py` | 🟡 WARNING | - | N/A | 0 / 0 / 9 | - | ✅ | 🔎 Pylance: 9 hiba javítása |
| `tests/neural_ai/ui/services/test_live_ops_service.py` | 🟡 WARNING | - | N/A | 0 / 0 / 28 | - | ✅ | 🔎 Pylance: 28 hiba javítása |
| `tests/neural_ai/ui/services/test_navigation_service.py` | 🟡 WARNING | - | N/A | 0 / 1 / 20 | - | ✅ | 🔬 Mypy: 1 type hiba javítása | 🔎 Pylance: 20 hiba javítása |
...
| `tests/neural_ai/ui/test_app.py` | 🟡 WARNING | - | N/A | 0 / 0 / 20 | - | ✅ | 🔎 Pylance: 20 hiba javítása |
| `tests/neural_ai/ui/test_core_bridge.py` | 🟡 WARNING | - | N/A | 0 / 0 / 5 | - | ✅ | 🔎 Pylance: 5 hiba javítása |
| `tests/neural_ai/ui/test_streamlit_app.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/neural_ai/ui/test_ui_factory.py` | 🟡 WARNING | - | N/A | 0 / 0 / 11 | - | ✅ | 🔎 Pylance: 11 hiba javítása |
| `tests/neural_ai/ui/test_ui_init.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/scripts/__init__.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/scripts/test_audit_architecture.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_audit_architecture_detailed.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_audit_data.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_bootstrap_integration_test.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_bootstrap_test.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_data_reset.py` | ✅ SECURE | - | N/A | 0 / 0 / 0 | - | ✅ | - |
| `tests/scripts/test_deploy_jforex.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_download_history.py` | 🟡 WARNING | - | N/A | 0 / 0 / 1 | - | ✅ | 🔎 Pylance: 1 hiba javítása |
| `tests/scripts/test_force_kill.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_generate.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_generate_docs.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_install.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_migrate_structure.py` | 🟡 WARNING | - | N/A | 0 / 0 / 10 | - | ✅ | 🔎 Pylance: 10 hiba javítása |
| `tests/scripts/test_scripts_init.py` | 🟡 WARNING | - | N/A | 0 / 0 / 1 | - | ✅ | 🔎 Pylance: 1 hiba javítása |
| `tests/scripts/test_smart_pack.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
| `tests/scripts/test_test_d2_standalone.py` | 🟡 WARNING | - | N/A | 0 / 0 / 2 | - | ✅ | 🔎 Pylance: 2 hiba javítása |
