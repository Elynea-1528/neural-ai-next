...
**Generálva:** 2026-02-16 17:12:07 UTC
...
| Modul / Fájl | Státusz | Teszt Pár | Teszt Eredmény | Cov (Stmt/Brch) | Lint/Type | Config | Logger | Teendők |
|--------------|---------|-----------|----------------|-----------------|-----------|--------|--------|---------|
...
| `core/config/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 31 | **26%** / 0% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `core/config/implementations/dynamic_config_manager.py` | 🟡 WARNING | ✅ FOUND | ✅ 48 | **10%** / 0% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `core/config/implementations/yaml_config_manager.py` | 🟡 WARNING | ✅ FOUND | ✅ 65 | **13%** / 0% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `core/config/interfaces/async_config_interface.py` | 🟡 WARNING | ✅ FOUND | ✅ 25 | 100% / 100% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
...
| `core/db/factory.py` | 🟡 WARNING | ✅ FOUND | ✅ 21 / ❌ **1** | **62%** / 100% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
...
| `core/db/implementations/sqlalchemy_session.py` | ✅ SECURE | ✅ FOUND | ✅ 22 | **17%** / 0% | 0 / 0 | ⚪ N/A | ✅ OK | - |
| `core/events/exceptions/event_error.py` | ✅ SECURE | ✅ FOUND | ✅ 9 | **54%** / 100% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `core/events/factory.py` | 🟡 WARNING | ✅ FOUND | ✅ 11 / ❌ **1** | **28%** / 100% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `core/events/implementations/zeromq_bus.py` | 🟡 WARNING | ✅ FOUND | ✅ 24 / ❌ **25** | **14%** / 0% | 0 / **1** | ✅ OK | ⚠️ UNUSED | - |
...
| `core/logger/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 5 | **30%** / 11% | 0 / **2** | ⚪ N/A | ⚪ N/A | - |
...
| `core/system/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 19 | **35%** / 0% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `core/system/implementations/health_monitor.py` | 🟡 WARNING | ✅ FOUND | ✅ 28 | **11%** / 0% | 0 / **1** | ⚪ N/A | ⚠️ UNUSED | - |
| `core/system/interfaces/health_interface.py` | ✅ SECURE | ✅ FOUND | ✅ 22 | 100% / 100% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `core/utils/decorators.py` | ✅ SECURE | ✅ FOUND | ✅ 2 / ❌ **11** | **39%** / 0% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `core/utils/exceptions/util_error.py` | 🔴 VULNERABLE | ❌ MISSING | - | **56%** / 100% | 0 / 0 | ⚪ N/A | ⚪ N/A | **KRITIKUS: Teszt írás!** |
| `core/utils/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 11 | **60%** / 100% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
...
| `collectors/jforex/implementations/bi5_downloader.py` | 🟡 WARNING | ✅ FOUND | ✅ 43 | **8%** / 0% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `collectors/jforex/implementations/live_feed.py` | ✅ SECURE | ✅ FOUND | ✅ 12 | **13%** / 0% | 0 / 0 | ⚪ N/A | ✅ OK | - |
...
| Modul / Fájl | Státusz | Teszt Pár | Teszt Eredmény | Cov (Stmt/Brch) | Lint/Type | Config | Logger | Teendők |
|--------------|---------|-----------|----------------|-----------------|-----------|--------|--------|---------|
| `data/ingestion/market_data_persister.py` | ✅ SECURE | ✅ FOUND | ✅ 20 | **7%** / 0% | 0 / **6** | ⚪ N/A | ✅ OK | - |
| `data/storage/backends/base.py` | 🟡 WARNING | ✅ FOUND | ✅ 2 / ❌ **6** | **32%** / 6% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `data/storage/backends/pandas_backend.py` | 🟡 WARNING | ✅ FOUND | ✅ 30 | **19%** / 3% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `data/storage/backends/polars_backend.py` | 🟡 WARNING | ✅ FOUND | ✅ 13 / ❌ **13** | **16%** / 2% | 0 / 0 | ⚪ N/A | ⚠️ UNUSED | - |
| `data/storage/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 12 | **28%** / 0% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
| `data/storage/implementations/file_storage.py` | ✅ SECURE | ✅ FOUND | ✅ 46 / ❌ **4** | **11%** / 0% | 0 / **5** | ⚪ N/A | ✅ OK | - |
| `data/storage/implementations/parquet_storage.py` | ✅ SECURE | ✅ FOUND | ✅ 33 / ❌ **1** | **12%** / 0% | 0 / **1** | ✅ OK | ✅ OK | - |
...
| `processors/implementations/time_alignment_service.py` | 🟡 WARNING | ✅ FOUND | ✅ 1 / ❌ **7** | **18%** / 0% | 0 / **2** | ⚪ N/A | ⚠️ UNUSED | - |
...
| `ui/factory.py` | ✅ SECURE | ✅ FOUND | ✅ 28 | **15%** / 0% | 0 / **17** | ⚪ N/A | ⚪ N/A | - |
...
| `ui/interfaces/data_service_interface.py` | ✅ SECURE | ✅ FOUND | ✅ 19 | 100% / 100% | 0 / 0 | ⚪ N/A | ⚪ N/A | - |
...
| `ui/services/data_service.py` | 🟡 WARNING | ✅ FOUND | ✅ 26 | **8%** / 0% | 0 / **6** | ⚪ N/A | ⚠️ UNUSED | - |
...
| `ui/services/strategy_service.py` | 🟡 WARNING | ✅ FOUND | ✅ 24 | **8%** / 0% | 0 / **8** | ⚪ N/A | ⚠️ UNUSED | - |
