...
**Generálva:** 2026-02-17 18:11:48 UTC
...
| `tests/collectors/jforex/test_bi5_downloader.py` | ✅ SECURE | **43**/0/0/0 | 0 / 0 / 0 |
...
| `tests/collectors/jforex/test_live_feed.py` | ✅ SECURE | **12**/0/0/0 | 0 / 0 / 0 |
| `tests/collectors/jforex/test_live_feed_integration.py` | 🔴 VULNERABLE | **8**/0/0/0 | 0 / 0 / 0 |
...
| `tests/core/base/implementations/test_di_container.py` | ✅ SECURE | **24**/0/0/0 | 0 / 0 / 0 |
...
| `tests/core/base/interfaces/test_component_interface.py` | ✅ SECURE | **13**/0/0/0 | 0 / 0 / 0 |
| `tests/core/base/interfaces/test_container_interface.py` | ✅ SECURE | **20**/0/0/0 | 0 / 0 / 0 |
| `tests/core/base/interfaces/test_interfaces_init.py` | ✅ SECURE | **12**/0/0/0 | 0 / 0 / 0 |
| `tests/core/base/test_base_init.py` | ✅ SECURE | **8**/0/0/0 | 0 / 0 / 0 |
| `tests/core/base/test_factory.py` | ✅ SECURE | **35**/0/0/0 | 0 / 0 / 0 |
...
| `tests/core/config/implementations/test_dynamic_config_manager.py` | ✅ SECURE | **48**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/implementations/test_dynamic_config_manager_comprehensive.py` | 🔴 VULNERABLE | **13**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/implementations/test_yaml_config_manager.py` | ✅ SECURE | **65**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/interfaces/test_async_config_interface.py` | 🟡 WARNING | **25**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/interfaces/test_config_interface.py` | ✅ SECURE | **17**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/interfaces/test_factory_interface.py` | ✅ SECURE | **23**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/test_config_factory.py` | ✅ SECURE | **31**/0/0/0 | 0 / 0 / 0 |
| `tests/core/config/test_processors_config.py` | ✅ SECURE | **0**/26/0/0 | 0 / 0 / 0 |
...
| `tests/core/db/implementations/test_db_implementations_init.py` | ✅ SECURE | **8**/0/0/0 | 0 / 0 / 0 |
| `tests/core/db/implementations/test_model_base.py` | ✅ SECURE | **12**/0/0/0 | 0 / 0 / 0 |
| `tests/core/db/implementations/test_models.py` | ✅ SECURE | **22**/0/0/0 | 0 / 0 / 0 |
| `tests/core/db/implementations/test_sqlalchemy_session.py` | ✅ SECURE | **22**/0/0/3 | 0 / 0 / 0 |
| `tests/core/db/interfaces/test_db_interfaces_init.py` | ✅ SECURE | **4**/0/0/0 | 0 / 0 / 0 |
| `tests/core/db/test_db_factory.py` | ✅ SECURE | **21**/1/0/0 | 0 / 0 / 0 |
...
| `tests/core/events/interfaces/test_event_models.py` | ✅ SECURE | **26**/0/0/0 | 0 / 0 / 0 |
...
| `tests/core/logger/interfaces/test_logger_factory_interface.py` | ✅ SECURE | **5**/0/0/0 | 0 / 0 / 0 |
| `tests/core/logger/interfaces/test_logger_interface.py` | ✅ SECURE | **3**/0/0/0 | 0 / 0 / 0 |
...
| `tests/core/logger/test_logger_init.py` | ✅ SECURE | **14**/0/0/0 | 0 / 0 / 0 |
| `tests/core/system/implementations/test_health_monitor.py` | ✅ SECURE | **28**/0/0/0 | 0 / 0 / 0 |
| `tests/core/system/interfaces/test_health_interface.py` | ✅ SECURE | **22**/0/0/0 | 0 / 0 / 0 |
| `tests/core/system/test_system_factory.py` | ✅ SECURE | **19**/0/0/0 | 0 / 0 / 0 |
| `tests/core/test_core_init.py` | ✅ SECURE | **11**/8/0/0 | 0 / 0 / 0 |
| `tests/core/test_init_version_fallback.py` | ✅ SECURE | **4**/1/0/0 | 0 / 0 / 0 |
...
| `tests/data/storage/backends/test_base.py` | ✅ SECURE | **2**/6/0/0 | 0 / 0 / 0 |
| `tests/data/storage/backends/test_pandas_backend.py` | ✅ SECURE | **30**/0/0/0 | 0 / 0 / 0 |
| `tests/data/storage/backends/test_polars_backend.py` | ✅ SECURE | **13**/13/0/4 | 0 / 0 / 0 |
| `tests/data/storage/implementations/test_file_storage.py` | ✅ SECURE | **46**/4/0/2 | 0 / 0 / 0 |
| `tests/data/storage/implementations/test_parquet_storage.py` | ✅ SECURE | **33**/1/0/0 | 0 / 0 / 0 |
...
| `tests/data/storage/test_storage_factory.py` | ✅ SECURE | **12**/0/0/0 | 0 / 0 / 0 |
| `tests/data/storage/test_storage_init.py` | ✅ SECURE | **5**/0/0/0 | 0 / 0 / 0 |
| `tests/processors/dimensions/d02_support/test_processor.py` | ✅ SECURE | **3**/1/0/0 | 0 / 0 / 0 |
| `tests/processors/test_factory.py` | ✅ SECURE | **3**/0/0/0 | 0 / 0 / 0 |
| `tests/processors/test_time_alignment_service.py` | ✅ SECURE | **1**/7/0/0 | 0 / 0 / 0 |
| `tests/scripts/test_data_reset.py` | ✅ SECURE | **12**/2/0/0 | 0 / 0 / 0 |
| `tests/scripts/test_download_history.py` | ✅ SECURE | **9**/2/0/0 | 0 / 0 / 0 |
| `tests/scripts/test_migrate_structure.py` | ✅ SECURE | **12**/1/0/0 | 0 / 0 / 0 |
| `tests/scripts/test_test_tick_pipeline.py` | ✅ SECURE | **4**/1/0/0 | 0 / 0 / 0 |
| `tests/scripts/test_validation_end_to_end.py` | ✅ SECURE | **2**/1/0/0 | 0 / 0 / 0 |
| `tests/test_dashboard_command.py` | ✅ SECURE | **6**/7/0/0 | 0 / 0 / 0 |
| `tests/test_main.py` | ✅ SECURE | **5**/6/0/0 | 0 / 0 / 0 |
| `tests/test_neural_ai_init.py` | ✅ SECURE | **4**/1/0/0 | 0 / 0 / 0 |
...
| `tests/ui/services/test_strategy_service.py` | ✅ SECURE | **24**/0/0/0 | 0 / 0 / 0 |
