...
**Visszatérési érték:**
- A lekért komponens példánya

**Kivételek:**
- `RuntimeError`: Ha a bridge nincs inicializálva vagy hiba történt a komponens létrehozásakor
- `ValueError`: Ha ismeretlen komponenstípus
...
- **Komponens hibák**: `RuntimeError` vagy `ValueError` kivételek a hibás komponens lekéréskor
...
- **Komponens lekérés**: Parquet storage és BI5 downloader lekérésének tesztelése
...
- [Core rendszer](../core/README.md)
- [JForex Collector](../collectors/jforex/README.md)
- [Parquet Storage](../core/storage/backends/parquet.md)