# 🧪 Teszt: tests/neural_ai/collectors/jforex/test_factory.py

**Tesztelt modul:** [`neural_ai/collectors/jforex/factory.py`](../../neural_ai/collectors/jforex/factory.py)

JForexFactory tesztek.

## Teszt Osztály: `TestJForexFactory`
...
**Teszt fájl:** [`tests/neural_ai/collectors/jforex/test_factory.py`](../../tests/neural_ai/collectors/jforex/test_factory.py)
