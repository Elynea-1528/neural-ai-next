# 🧪 Teszt: tests/neural_ai/processors/implementations/test_time_alignment_service.py

**Tesztelt modul:** [`neural_ai/processors/implementations/time_alignment_service.py`](../../neural_ai/processors/implementations/time_alignment_service.py)

TimeAlignmentService tesztek.

## Teszt Osztály: `MockLogger`

Mock logger implementáció a teszteléshez.

## Teszt Osztály: `TestTimeAlignmentService`
...
**Teszt fájl:** [`tests/neural_ai/processors/implementations/test_time_alignment_service.py`](../../tests/neural_ai/processors/implementations/test_time_alignment_service.py)
