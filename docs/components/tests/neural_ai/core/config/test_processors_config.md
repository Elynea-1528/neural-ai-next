# 🧪 Teszt: tests/neural_ai/core/config/test_processors_config.py

**Tesztelt modul:** [`neural_ai/core/config/processors_config.py`](../../neural_ai/core/config/processors_config.py)
...
## Teszt Osztály: `TestProcessorsConfig`
...
**Teszt fájl:** [`tests/neural_ai/core/config/test_processors_config.py`](../../tests/neural_ai/core/config/test_processors_config.py)
