# 🧪 Teszt: tests/neural_ai/core/logger/interfaces/test_factory_interface.py

**Tesztelt modul:** [`neural_ai/core/logger/interfaces/factory_interface.py`](../../neural_ai/core/logger/interfaces/factory_interface.py)

Logger factory interfész tesztek.

## Teszt Osztály: `TestLoggerFactoryInterface`
...
**Teszt fájl:** [`tests/neural_ai/core/logger/interfaces/test_factory_interface.py`](../../tests/neural_ai/core/logger/interfaces/test_factory_interface.py)
